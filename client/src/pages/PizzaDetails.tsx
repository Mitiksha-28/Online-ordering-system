...
import products from "@client/assets/fake-data/products.js";
import { useParams } from "react-router-dom";
import Helmet from "@client/components/Helmet/Helmet.js";
import CommonSection from "../components/UI/common-section/CommonSection.js";
import { Container, Row, Col } from "reactstrap";
import ExtraIngredient from "../components/ExtraIngredient/ExtraIngredient.js";
import { useDispatch } from "react-redux";
import { cartActions } from "@client/store/shopping-cart/cartSlice.js";
...
import { CartItem, ProductItem } from "@client/vite-env.js";
...
const MenuItemDetails = () => {
  ...
  const product: ProductItem = products.find((product) => product.id === id) || {
    id: "",
    title: "",
    price: 0,
    image01: "",
  ...
  const cartProducts = useSelector<{ cart: { cartItems: CartItem[] } }, CartItem[]>((state) => state.cart.cartItems);
